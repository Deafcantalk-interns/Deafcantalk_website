      ...
      <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-4 animate-fade-in">
            ...
            <div className="flex gap-3 mt-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-white bg-opacity-20 flex items-center justify-center hover:bg-opacity-30 transition-all duration-300 hover-scale"
              >
          ...
          <div className="flex flex-col gap-4 animate-fade-in delay-200">
            ...
            <div className="flex items-center gap-3 text-gray-200 hover:text-white transition-colors">
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
              </svg>
              <a href="mailto:support@deafcantalk.org" className="no-underline text-gray-200 hover:text-white">
                support@deafcantalk.org
              </a>
            </div>
            <div className="flex items-center gap-3 text-gray-200 hover:text-white transition-colors">
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="tel:+233533634102" className="no-underline text-gray-200 hover:text-white">
                +233 53 363 4102
              </a>
            </div>
            <div className="flex items-start gap-3 text-gray-200">
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24" className="mt-1">
          ...
          <div className="flex flex-col gap-4 animate-fade-in delay-300">
            ...
            <p className="text-gray-200 text-sm">Subscribe to our newsletter for the latest updates and resources.</p>
            <div className="flex flex-col gap-3">
              <input
                type="email"
                placeholder="Enter your email"
                className="px-4 py-3 rounded-lg bg-white bg-opacity-20 border border-white border-opacity-30 text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 transition-all"
              />
              <button className="px-6 py-3 rounded-lg font-semibold text-white bg-white bg-opacity-20 hover:bg-opacity-30 transition-all duration-300 hover-lift">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-white border-opacity-20 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-200 text-sm text-center md:text-left">
              © 2025 DeafCanTalk. All rights reserved. Made with ❤️ for the deaf community.
            </p>
            <div className="flex gap-6 text-sm">
              <button className="text-gray-200 hover:text-white transition-colors bg-transparent border-none cursor-pointer text-sm">
                Privacy Policy
              </button>
              <button className="text-gray-200 hover:text-white transition-colors bg-transparent border-none cursor-pointer text-sm">
                Terms of Service
